package com.kg.poc.crnk.controller;
...
import com.kg.poc.crnk.model.Organization;
import com.kg.poc.crnk.model.Role;
import com.kg.poc.crnk.model.Staff;
import com.kg.poc.crnk.util.CrnkUtil;
...
public class PocController {
	...
	public Object getData() {
		...
		staffRelationShip.put(Organization.class.getSimpleName(),
				mCrnkUtil.getRelationshipObject(String.valueOf(org.getId()), Organization.class.getSimpleName()));
		staffRelationShip.put(Role.class.getSimpleName(),
				mCrnkUtil.getRelationshipObject(String.valueOf(role.getId()), Role.class.getSimpleName()));
		...
		Resource resourceStaff = mCrnkUtil.getResourceObject(String.valueOf(staffData.getId()),
				Staff.class.getSimpleName(), staffAttributes, staffRelationShip, staffLinkObject);
	...
	public Object getError() {
		...
		errorDataList.add(mCrnkUtil.getErrorData("SUM-01-101", "Input not valid", "Email id not valid", "sourcePointer",
				"sourceParam"));
