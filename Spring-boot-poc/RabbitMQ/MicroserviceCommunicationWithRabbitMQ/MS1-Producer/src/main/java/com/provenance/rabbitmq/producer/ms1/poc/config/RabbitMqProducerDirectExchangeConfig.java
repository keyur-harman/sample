package com.provenance.rabbitmq.producer.ms1.poc.config;
...
@Configuration
public class RabbitMqProducerDirectExchangeConfig {
...
//	    }
	    ...
	    public AmqpTemplate amqpTemplate(ConnectionFactory connectionFactory) {
	    	System.out.println("ConnectionFactory = "+connectionFactory.getHost()+connectionFactory.getPort()+connectionFactory.getUsername());
